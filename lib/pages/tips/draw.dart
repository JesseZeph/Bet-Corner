...
class DrawTips extends StatefulWidget {
  const DrawTips({Key? key}) : super(key: key);

  @override
  State<DrawTips> createState() => _DrawTipsState();
}

class _DrawTipsState extends State<DrawTips> {
  late DatabaseReference tipsRef;

  @override
  void initState() {
    super.initState();
    tipsRef = FirebaseDatabase.instance.ref().child('tips/draw');
  }
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: tipsAppBar(title: const Text('Draw', style: TextStyle(fontSize: 20),)),
